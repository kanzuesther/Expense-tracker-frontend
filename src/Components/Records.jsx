...
const Records = () => {
    ...
    return (
        <div className="w-screen h-screen bg-[#eef0f2] overflow-auto">
            ...
            <div className="mt-4 px-6 flex flex-row gap-3">
                <div className="h-full bg-[#fafbfd] w-1/5 p-3 rounded-md flex flex-col gap-[24px]">
                    ...
                    <div className="bg-white px-3 py-1 rounded-md display-flex flex flex-row gap-3 items-center">
                    ...
                    <div>
                        ...
                        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className="text-white bg-[#8BC34A] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Dropdown button <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
