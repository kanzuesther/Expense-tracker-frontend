...
const Records = () => {
    ...
    const [afterOpenModal, setafterOpenModal] = useState(false);
        ...
        <div className="w-screen h-screen bg-[#eef0f2] overflow-auto">
            ...
            <div className="mt-4 px-6 flex flex-row gap-3">
                <div className="h-full bg-[#fafbfd] w-1/5 p-3 rounded-md flex flex-col gap-[24px]">
                    ...
                    <button className="rounded-full px-3 py-1 bg-[#01aa71] text-white">+ Add</button>
                                ...
                                <div className="w-3/5 flex flex-col gap-4">
                                    ...
                                    <div className="flex flex-col items-center">
                                        ...
                                        <div className="mt-2 flex flex-col items-center justify-center ">
                                            <button className="text-white bg-green-900 w-full py-1 px-6 rounded-full">Add record</button>
